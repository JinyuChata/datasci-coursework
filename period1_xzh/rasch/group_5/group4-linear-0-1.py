...
for user_id in group_people["g5"]:
    ...
    for case in group_exercises["g5"]:
        # if int(case) in [2550,2666,2663,2672]:
        #     continue
...
for user_id in group_people["g5"]:
    ...
    for j in range(len(cases)):
        ...
        # if int(case_id) in [2550,2666,2663,2672]:
        #     continue
...
#有很多nan 原因是有一个人做了很多别的组的题 57559,因此上面的json数据里面去掉57559
# df_group5=df_group5.drop(['57559'])

print(df_group5)

df_group5.to_csv("./group5_results_linear_0_1.csv",index=False,header=True)
