...
for user_id in group_people["g5"]:
    ...
    for case in group_exercises["g5"]:
        if(int(case) in [2718,2701,2729,2737,2738,2739,2740,2741]):
            continue
...
for user_id in group_people["g5"]:
    ...
    for j in range(len(cases)):
        ...
        if(int(case_id) in [2718,2701,2729,2737,2738,2739,2740,2741]):
            continue
...
df_group5.to_csv("./group5_results_searching_0_1.csv",index=False,header=True)