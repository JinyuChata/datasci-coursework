...
for user_id in group_people["g5"]:
    ...
    for case in group_exercises["g5"]:
        case_id=case
        if (int(case_id) in [2523,2525,2527,2528,2533,2536,2539,2542]):
            continue
...
for user_id in group_people["g5"]:
    ...
    for j in range(len(cases)):
        ...
        # if(case_id=='2556' or case_id=='2773' or case_id=='2550'):
        #     continue
        if (int(case_id) in [2523,2525,2527,2528,2533,2536,2539,2542]):
            continue
...
df_group5.to_csv("./group5_results_sorting_0_1.csv",index=False,header=True)