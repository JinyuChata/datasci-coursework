...
for user_id in group_people["g2"]:
    ...
    for case in group_exercises["g2"]:
        if(int(case) in [2149,2151,2152,2167,2168,2174,2444])or (case=="2804" or case=="2456" or case=="2309"):
            continue
...
for user_id in group_people["g2"]:
    ...
    for j in range(len(cases)):
        ...
        if(int(case_id) in [2149,2151,2152,2167,2168,2174,2444])or (case_id=="2804" or case_id=="2456" or case_id=="2309"):
            continue
...
df_group2=df_group2.fillna(0)


print(df_group2)

df_group2.to_csv("./group2_results_graph_0_1.csv",index=False,header=True)