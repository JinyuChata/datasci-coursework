...
for user_id in group_people["g2"]:
    ...
    for case in group_exercises["g2"]:
        case_id=case
        if (case_id == "2804" or case_id == "2456" or case_id == "2309" or case_id == '2527' or case_id == '2530' or case_id == '2531'or case_id=="2542"):
            continue
        if(classify_items[case]["题目类别"]=="排序算法"):
            user_scores[case] = 0
...
for user_id in group_people["g2"]:
    ...
    for j in range(len(cases)):
        ...
        if len(uploads)>0 and type=="排序算法":
...
df_group2.to_csv("./group2_results_sorting_0_1.csv",index=False,header=True)