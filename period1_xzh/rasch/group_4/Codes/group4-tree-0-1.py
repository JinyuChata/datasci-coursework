...
for user_id in group_people["g4"]:
    ...
    for case in group_exercises["g4"]:
        if case=="2726" or case=="2704" or int(case) in [2526]:
            continue
...
for user_id in group_people["g4"]:
    ...
    for j in range(len(cases)):
        ...
        if(case_id=="2726" or case_id=="2704" or case_id=="2526"):
            continue
...
df_group4.to_csv("./group4_results_tree_0_1.csv",index=False,header=True)