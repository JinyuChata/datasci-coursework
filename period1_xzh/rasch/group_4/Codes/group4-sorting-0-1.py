...
for user_id in group_people["g4"]:
    ...
    for case in group_exercises["g4"]:
        case_id=case
        if (case_id == '2546' or case=="2773" or case == '2440'):
            continue
...
for user_id in group_people["g4"]:
    ...
    for j in range(len(cases)):
        ...
        if(case_id=='2546' or case_id=='2773' or case_id=='2440'):
            continue
...
df_group4.to_csv("./group4_results_sorting_0_1.csv",index=False,header=True)