...
for user_id in group_people["g4"]:
    ...
    for case in group_exercises["g4"]:
        if int(case) in [2666,2664,2672,2456,2489,2494,2500,2522,2692]:
            continue
...
for user_id in group_people["g4"]:
    ...
    for j in range(len(cases)):
        ...
        if int(case_id) in [2666,2664,2672,2456,2489,2494,2500,2522,2692]:
            continue
...
df_group4.to_csv("./group4_results_array_0_1.csv",index=False,header=True)